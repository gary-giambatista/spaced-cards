...
function Add_Card_Modal({
	...
	return (
		<div className="@container absolute h-full w-full left-0 top-0 bg-black bg-opacity-10 flex items-start justify-center @lg:items-center overflow-scroll md:overflow-hidden backdrop-blur-sm p-2 z-10">
